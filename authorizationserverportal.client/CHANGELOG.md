...
- Create Angular project with ng: `ng new authorizationserverportal.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`authorizationserverportal.client.esproj`).
